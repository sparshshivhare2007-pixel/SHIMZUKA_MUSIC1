...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","shizuuXmusicbot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/sparshshivhare2007-pixel/SHIMZUKA_MUSIC1.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SHIMZUKA_NETWORK")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/SHIMZUKA_SUPPORT")
